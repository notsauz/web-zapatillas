    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h2 class="text-primary">{{ $totalSneakers }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h2 class="text-success">{{ $totalBrands }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h2 class="text-info">${{ number_format($averagePrice, 2) }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h2 class="text-warning">{{ $recentSneakersCount }}</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($recentSneakers as $sneaker)
                            <tr>
                                <td>{{ $sneaker->name }}</td>
                                <td>
